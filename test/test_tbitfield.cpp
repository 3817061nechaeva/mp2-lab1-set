...
TEST(TBitField, compare_two_non_equal_bitfields)
{
  const int size = 4;
  TBitField set1(size), set2(size);
  // set1 = {1010}
  set1.SetBit(1);
  set1.SetBit(3);
  // set2 = {0110}
...
TEST(TBitField, compare_two_bitfield_of_non_equal_sizes)
{
...
TEST(TBitField, compare_two_bitfields)
{
  const int size = 4;
  TBitField set1(size), set2(size);
  // set1 = {1010}
